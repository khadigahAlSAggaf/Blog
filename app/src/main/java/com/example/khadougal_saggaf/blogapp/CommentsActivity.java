...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("Posts/" + blog_post_id + "/Comments").orderBy("timestamp", Query.Direction.DESCENDING)
                .addSnapshotListener(CommentsActivity.this, new EventListener<QuerySnapshot>() {//send Activity in snapshotListener to link it with time of lunching specific activity
                    @Override
                        ...
                        if (!documentSnapshots.isEmpty()) {
                            ...
                            for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                                ...
                                if (doc.getType() == DocumentChange.Type.ADDED) {
                                    ...
                                    Comments comments = doc.getDocument().toObject(Comments.class); //download document data as object of class
        ...
        //if(comment_field.getText().toString().equals(null)) {
        // Comments Post
        ...
        //}else{
        //Toast.makeText(CommentsActivity.this, "noooo bara : " , Toast.LENGTH_SHORT).show();
